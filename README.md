...
- **Sentence-Level Literature Analysis**:
  - Find relevant literature for each sentence in a paragraph
  - Find supporting literature for validation
...
#### Sentence-Level Literature Analysis
```
Find relevant literature: "Machine learning is transforming healthcare. Deep learning models analyze medical images for diagnosis."
```
